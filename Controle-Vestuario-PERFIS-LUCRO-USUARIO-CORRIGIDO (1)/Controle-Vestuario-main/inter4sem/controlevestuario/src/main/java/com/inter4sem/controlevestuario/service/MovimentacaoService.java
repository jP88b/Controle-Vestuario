...
public class MovimentacaoService {
    ...
    public MovimentacaoEntity editar(int id, MovimentacaoEntity Movimentacao) {
        ...
        if (MovimentacaoExistente.isPresent()) {
            ...
            MovimentacaoAtualizada.setPrecoCusto(Movimentacao.getPrecoCusto());
            MovimentacaoAtualizada.setPrecoVenda(Movimentacao.getPrecoVenda());
            MovimentacaoAtualizada.setProduto(Movimentacao.getProduto());
